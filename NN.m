function [class] = NN(point, coordinate, class_data_1, class_data_2, class_data_3)
...
if (exist('class_data_3', 'var'))
    ...
    min_distances = [distances_1, distances_2, distances_3];
    if((min(min_distances) == distances_1) && (distances_1 == distances_2))
        class = 0;
    elseif((min(min_distances) == distances_1) && (distances_1 == distances_3))
        class = 0;
%     elseif((min(min_distances) == distances_2) && (distances_2 == distances_1))
%         class = 0;
    elseif((min(min_distances) == distances_2) && (distances_2 == distances_3))
        class = 0;
%     elseif((min(min_distances) == distances_3) && (distances_3 == distances_1))
%         class = 0;
%     elseif((min(min_distances) == distances_3) && (distances_3 == distances_2))
%         class = 0;
    elseif((distances_1 == distances_2) && (distances_2 == distances_3))
        class = 0;
    elseif min(min_distances) == distances_1
        class = 1;
    elseif min(min_distances) == distances_2
        class = 2;
    elseif min(min_distances) == distances_3
        class = 3;
    end

else
    min_distances = [distances_1, distances_2];
